...
__all__ = ['resnet8', 'resnet20', 'resnet32',
           'resnet50', 'resnet56', 'resnet110']
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=1000, block_name='BasicBlock'):
        ...
        self.output = nn.Linear(64 * block.expansion, num_classes)
...
def resnet8(**kwargs):
    net = ResNet(depth=8, **kwargs)
    # net = convert_groupnorm(net)
    return net


def resnet20(**kwargs):
    net = ResNet(depth=20, **kwargs)
    # net = convert_groupnorm(net)
    return net
